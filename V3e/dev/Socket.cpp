...
int Socket::_Recv(void *buffer, int bufferLen)
{
    int rtn = 0;
...
void Socket::_Send(const char *buffer)
{
...
void Socket::_Create(int _type, int _protocol)
{   
...
void Socket::_Bind(const std::string &_address, unsigned short _port)
{
    sockaddr_in _addr;
...
bool Socket::_Connect(const char *addr, int port)
{
...
void Socket::_SetOptions(int nOptions)
{
...
void Socket::_SetBlocking(bool bBlock)
{
    u_long iMode = 0;
...
void Socket::_fillAddr(const std::string &address, unsigned short port, sockaddr_in &addr)
{
