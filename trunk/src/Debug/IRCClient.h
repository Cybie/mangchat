...
public:
	...
	// Convert to Wstring
	wstring ConvertString(std::string sData, std::string &sData2 = std::string(""));
	// Convert to string
	string ConvertwString(std::string sData, std::wstring &sData2 = std::wstring(L""));

public:
	// Locale Info Variable
	wchar_t* localeInfo;

	// Locale Info Variable
	char * localeInfo_start;
